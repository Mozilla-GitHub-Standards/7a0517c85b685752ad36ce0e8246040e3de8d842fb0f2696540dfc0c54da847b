...
let
  ...
  generated = self: {
    ...
    "cloudpickle" = python.mkDerivation {
      name = "cloudpickle-0.8.1";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/33/9c/b785fe61fd43fb673532caca18d6c398e86faaf7d283266c7ed23db4ee5e/cloudpickle-0.8.1.tar.gz";

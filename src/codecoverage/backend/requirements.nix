...
let
  ...
  generated = self: {
    ...
    "fakeredis" = python.mkDerivation {
      name = "fakeredis-1.0.3";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/a2/98/e522a70987b35052f2776f654b014c01218ce6a473711277d3a7c2570931/fakeredis-1.0.3.tar.gz";

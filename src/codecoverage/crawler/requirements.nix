...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-vca687j3/src/codecoverage/crawler/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -s intreehooks -s flit -s pytest-runner -s setuptools-scm -r requirements.txt -r requirements-dev.txt
#
...
let
  ...
  generated = self: {
    ...
    "firefox-code-coverage" = python.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url = "https://github.com/marco-c/firefox-code-coverage/archive/781a78d5225334772392ad9e7056bcdc76bf805a.tar.gz";
        sha256 = "3dabff6b102c85939b6754f5261b8602deb58ebdba90d0580ed2393d0521aab5";
      };
      doCheck = commonDoCheck;
      checkPhase = "";
      installCheckPhase = "";

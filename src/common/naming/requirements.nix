...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-qvcv12r3/src/common/naming/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -s intreehooks -s flit -s pytest-runner -s setuptools-scm -r requirements-dev.txt
#

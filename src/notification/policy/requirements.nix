...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-jwexj8ip/src/notification/policy/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -E postgresql -s intreehooks -s flit -s vcversioner -s pytest-runner -s setuptools-scm -r requirements.txt -r requirements-dev.txt
#

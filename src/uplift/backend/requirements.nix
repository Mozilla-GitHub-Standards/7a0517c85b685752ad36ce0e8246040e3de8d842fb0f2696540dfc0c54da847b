...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-8kuqhkot/src/uplift/backend/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -E postgresql -s intreehooks -s flit -s vcversioner -s pytest-runner -s setuptools-scm -r requirements.txt -r requirements-dev.txt
#
...
let
  ...
  generated = self: {
    ...
    "aresponses" = python.mkDerivation {
      name = "aresponses-1.1.1";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/e8/13/0f135ca4a82f0defef7a9f02faf4047f64566f0bba25a15583f8757cde44/aresponses-1.1.1.tar.gz";
    ...
    "async-lru" = python.mkDerivation {
      name = "async-lru-1.0.2";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/7e/c1/a3d6207deaaeb582d16dc9a0fd217f192efc9487ce59897131cf9a2bdc1c/async_lru-1.0.2.tar.gz";
    ...
    "kombu" = python.mkDerivation {
      name = "kombu-4.4.0";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/a9/c3/27fdf506ff2701c750095494e185ba3e2e00b156b495a5328db662c2a4b0/kombu-4.4.0.tar.gz";
